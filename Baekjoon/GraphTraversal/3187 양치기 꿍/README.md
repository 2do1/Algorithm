...
| :-------- | :---------- | :--- | :--- | :-------- | :-------- |
| 1 초      | 128 MB      | 3499 | 2201 | 1862      | 65.494%   |
...
DFS, BFS 알고리즘을 이용해 풀이하였다.

DFS 알고리즘으로 풀이할 때는 sys.setrecursionlimit()을 통해 재귀 깊이 제한을 풀어줬어야 했다.

[3184 양](https://www.acmicpc.net/problem/3184)과 유사한 문제였다.