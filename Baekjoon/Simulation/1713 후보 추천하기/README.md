...
| :-------- | :---------- | :---- | :--- | :-------- | :-------- |
| 2 초      | 128 MB      | 14940 | 4325 | 3325      | 31.034%   |
...
items() 함수를 이용해 (key, value) 쌍을 갖고올 수 있다는 것을 기억하자.

게시된 지 가장 오래된 사진을 삭제할 때 index() 함수를 이용해 인덱스 값이 작은 것을 삭제했다. 스택 자료구조의 성질을 이용했어야 했던 것 같다.