...
| :-------- | :---------- | :---- | :--- | :-------- | :-------- |
| 1 초      | 128 MB      | 14922 | 6674 | 5533      | 45.622%   |
...
20%에서 계속 틀렸다고 해서 어떤 반례가 있는지 계속 생각했다.

이전 코드는 빙고 개수가 3개일때 출력하도록 하였는데, 이러면 다음 숫자로 인해 빙고 개수가 2개에서 4개로 변하는 경우는 인식하지 못하는 반례가 발생했다.

따라서 빙고 개수가 3개가 아닌, 3개 이상일때 출력을 해주었더니 정답이 되었다.

[참고 링크](https://www.acmicpc.net/board/view/34599)

sys.exit(0)을 통해 프로그램을 종료하였다.