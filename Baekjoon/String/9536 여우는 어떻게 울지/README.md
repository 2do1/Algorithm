...
| :-------- | :---------- | :--- | :--- | :-------- | :-------- |
| 1 초      | 128 MB      | 3813 | 1605 | 1285      | 41.667%   |
...
split() 함수와 remove() 함수를 이용하여 풀이하였다.

여우를 제외한 동물의 울음소리들을 split() 함수를 통해 가져와, remove() 함수를 통해 녹음된 소리에서 제거해주었고, join() 함수를 통해 여우의 울음소리를 합쳐준 뒤 출력하였다.