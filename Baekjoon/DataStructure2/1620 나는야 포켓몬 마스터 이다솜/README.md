...
| :-------- | :---------- | :---- | :---- | :-------- | :-------- |
| 2 초      | 256 MB      | 75072 | 26371 | 19738     | 33.773%   |
...
리스트로 탐색을 진행할 경우 시간복잡도는 O(n)이다. 리스트로 탐색을 진행했을 때는 시간초과가 발생했다.

딕셔너리로 탐색을 진행할 경우 시간복잡도는 O(1)이다. 파이썬 딕셔너리는 해시 테이블을 사용한 자료구조이다.

[참고 자료](https://trey-de.tistory.com/7)