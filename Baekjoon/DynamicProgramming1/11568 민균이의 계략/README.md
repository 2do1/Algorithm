...
| :-------- | :---------- | :--- | :--- | :-------- | :-------- |
| 1 초      | 256 MB      | 2994 | 1557 | 1335      | 54.691%   |
...
가장 긴 증가하는 부분 수열 LIS(Longest Increasing Sequence)의 기본 문제 중 하나였다.

dp[i]는 cards[i]를 마지막 값으로 가지는 가장 긴 증가 부분 수열의 길이이다.

dp 리스트 중 가장 큰 값이 배열 중 가장 긴 부분수열의 길이다.
